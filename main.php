...
<body id="dokuwiki__top">
    <div id="dokuwiki__site" class="<?php echo tpl_classes(); ?> <?php echo ($showSidebar) ? 'hasSidebar' : ''; ?>">
        ...
        <div id="sidebar_wrapper">
			...
			<?php /* SHOW SITE AND PAGE TOOLS ONLY FOR REGISTERED USERS */?>
					<?php if (!empty($_SERVER['REMOTE_USER'])): ?> 
					<!-- PAGE TOOLS -->
					<div id="dokuwiki__pagetools">
						<h3><?php echo $lang['page_tools'] ?></h3>
						<ul>
							<?php whiteresume_toolsevent('pagetools', array(
					...
					<div id="dokuwiki__sitetools">
						...
						<ul>
							<?php whiteresume_toolsevent('sitetools', array(
                ...
                <?php endif; /* END SHOWING SITE AND PAGE TOOLS ONLY FOR REGISTERED USERS */ ?> 
                <!-- USER TOOLS -->
                <?php if ($conf['useacl']): ?>
                <div id="dokuwiki__usertools">
                    ...
                    <ul>
                        <?php 
						whiteresume_toolsevent('usertools', array(

                            'login'     => tpl_action('login', 1, 'li', 1, '<span>', '</span>'),
							'register'  => tpl_action('register', 1, 'li', 1, '<span>', '</span>'),
                        )); 
						// Show additional tools only if user is logged in
        ...
        <div class="wrapper group">
            ...
            <div id="dokuwiki__footer">
                <?php if($INFO['exists']): ?>
                <div class="doc"><?php whiteresume_pageinfo() ?></div>
                <?php endif ?>
                <?php tpl_includeFile('sidebarfooter.html') ?>
